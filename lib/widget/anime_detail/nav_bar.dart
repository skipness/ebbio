...
class CupertinoTransparentNavigationBar extends StatefulWidget implements ObstructingPreferredSizeWidget {
  /// Creates a navigation bar in the iOS style.
  const CupertinoTransparentNavigationBar({
    Key key,
    this.leading,
  ...
  @override
  _CupertinoTransparentNavigationBarState createState() {
    return _CupertinoTransparentNavigationBarState();
  }
}
...
class _CupertinoTransparentNavigationBarState extends State<CupertinoTransparentNavigationBar> {
